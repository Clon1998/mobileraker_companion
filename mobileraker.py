...
class Client:
    ...
    async def task_firebase(self):
        ...
        try:
            res = requests.post(self.mobileraker_fcm, json=msg)
...
def main() -> None:
    ...
    try:
        client = Client(moonraker_uri='ws://127.0.0.1/websocket', fcm_uri='http://192.168.178.157:8080/companion/update', loop=event_loop)
